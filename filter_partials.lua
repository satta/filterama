...
name        = "Partial gene filter"
author      = "Sascha Steinbiss"
version     = "1.0"
email       = "ss34@sanger.ac.uk"
short_descr = "Remove partial genes."
description = "Selects only features which are not partial genes, denoted by "
              .. "(Start_range/End_range or {three,five}EndPartial)."
